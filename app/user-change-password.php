...
<div class="wrapper">
                                    ...
                                    <div class="iq-edit-list usr-edit">
                                        <ul class="iq-edit-profile d-flex nav nav-pills">
                                            <li class="col-md-3 p-0">
                                                <a class="nav-link" href="user-profile-edit.php">Personal Information</a>
                                            </li>
                                            <li class="col-md-3 p-0">
                                                <a class="nav-link active" href="user-change-password.php">Change Password</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="form-group col-md-12">
        ...
        <input type="password" name="password_baru" class="form-control" id="npass" required>
    </div>
    <div class="form-group col-md-12">
        <label for="vpass">Verify Password:</label>
        <input type="password" name="konfirmasi_password" class="form-control" id="vpass" required>
    </div>
    <br>
